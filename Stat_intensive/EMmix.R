...
# library(mvtnorm)
# pi.est.vec=c(0.25,0.25,0.25,0.25)
# mu.est.list=list(c(1,1),c(0,0),c(2,2),c(3,3))
# sigma.est.list=list(matrix(c(1,0,0,1),ncol=2),matrix(c(1,0,0,1),ncol=2),matrix(c(1,0,0,1),ncol=2),matrix(c(1,0,0,1),ncol=2))
# T.mat=matrix(0, nrow = 400, ncol = 4)
...
kable(as.data.frame(output$props[its,]), digits = 4, caption="Mixing Proportion Estimates at final iteration of EM",
      col.names=c("pi.1","pi.2","pi.3","pi.4"))
...
plot(x.axis, means1.mat[,1], type = "l", lwd=2.5, col="blue2", ylim=c(min(means1.mat), max(means1.mat)),
     main=paste("Estimate mean vec1"), xlab="Iteration", sub=paste("starting values", mu0[[1]], sep="_") )
...
plot(x.axis, means2.mat[,1], type = "l", lwd=2.5, col="blue2", ylim=c(min(means2.mat), max(means2.mat)),
     main=paste("Estimate mean vec2"), xlab="Iteration", sub=paste("starting values", mu0[[2]], sep="_") )
...
plot(x.axis, means3.mat[,1], type = "l", lwd=2.5, col="blue2", ylim=c(min(means3.mat), max(means3.mat)),
     main=paste("Estimate mean vec3"), xlab="Iteration", sub=paste("starting values", mu0[[3]], sep="_") )
...
plot(x.axis, means4.mat[,1], type = "l", lwd=2.5, col="blue2", ylim=c(min(means4.mat), max(means4.mat)),
     main=paste("Estimate mean vec4"), xlab="Iteration", sub=paste("starting values", mu0[[4]], sep="_") )
